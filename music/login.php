...
<head>
  ...
  <title>Login | Kiyoshi Music</title>
...
<style>
	body{
		...
		background-image: url("https://img.freepik.com/free-vector/glowing-musical-pentagram-background-with-sound-notes_1017-31220.jpg?size=626&ext=jpg&ga=GA1.1.1700460183.1708387200&semt=ais");
  	...
  	<div class="container">
  		...
  		<div id="login-center" class="row justify-content-center align-self-center w-100">
  			<div class="d-flex justify-content-center align-items-center w-100">
  				...
  				<h2 class="text-gradient-primary"><b>Kiyoshi Music.</b></h2>
  				</span>
  			</div>
